...
export default function FileListItem({ file, selected, onPreview, onDelete, onToggleSelect, onMove }: Props) {
  ...
  return (
    <div className={`${styles.row} ${selected ? styles.selected : ''}`}>
      <div className={styles.checkCol} onClick={(e) => { e.stopPropagation(); onToggleSelect(file.id) }}>
        <input type="checkbox" checked={!!selected} readOnly />
      </div>
      <div className={styles.info} onClick={() => onPreview(file)}>
